...
Store operational recovery procedures here, including Kafka consumer lag, Outbox backlog, PostgreSQL or Redis unavailability, poison messages, Saga recovery, and rollback.
